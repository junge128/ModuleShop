...
<head>
  ...
  <title>Android使用教程 &mdash; 模块化商店</title>
            ...
            <div class="card">
             <div class="card-body">
              <ul class="steps">
               <li>
                <div class="row">
                 <div class="left-text col-xs-12 col-md-6 col-lg-6">
                  ...
                  <p>下载客户端。</p>
                  <a href="files/V2rayNG.apk" class="btn btn-icon icon-left btn-primary btn-app btn-lg btn-round" target="blank"><i class="fas fa-download"></i> 下载客户端</a>
                 </div>
                </div></li>
               <li>
                <hr />
                <div class="row">
                 <div class="left-text col-xs-12 col-md-6 col-lg-6">
                  ...
                  <p>点击这个按钮 👇👇👇 复制订阅地址</p>
                  <a href="##" class="btn btn-icon icon-left btn-primary btn-app btn-lg btn-round copy-text" onclick="Copyconfig()" data-clipboard-text="<?php echo $_SESSION["vmess_commond"]?>"><i class="malio-v2rayng"></i> 复制订阅链接</a>
                 </div>
                </div> </li>
               <li>
                  <hr />
               ...
               <div class="center-pic col-xs-12">
                  <hr />
                  <img class="img" src="image2/android/1.png">
               </div>
               <div class="center-pic col-xs-12">
                  <hr />
                  <img class="img" src="image2/android/2.png">
               </div>
               <div class="center-pic col-xs-12">
                  <hr />
                  <img class="img" src="image2/android/3.png">
               </div>
               <div class="center-pic col-xs-12">
                  <hr />
                  <img class="img" src="image2/android/4.png">
               </div>
               <div class="center-pic col-xs-12">
                  <hr />
                  <img class="img" src="image2/android/5.png">
               </div>
               <div class="center-pic col-xs-12">
                  <hr />
                  <img class="img" src="image2/android/55.png">
               </div>
               <div class="center-pic col-xs-12">
                  <hr />
                  <img class="img" src="image2/android/6.png">
               </div>
               <div class="center-pic col-xs-12">
                  <hr />
                  <img class="img" src="image2/android/7.png">
               </div>
               <div class="center-pic col-xs-12">
                  <hr />
                  <img class="img" src="image2/android/8.png">
               </div>
