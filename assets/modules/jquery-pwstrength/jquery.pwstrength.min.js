...
(b+=10);return b<15?0:b<20?1:b<35?2:b<50?3:4};c.fn.pwstrength=function(a){a=c.extend({label:".label",classes:["pw-very-weak","pw-weak","pw-mediocre","pw-strong","pw-very-strong"],texts:['密码强度较弱', '密码强度弱', '密码强度适中', '密码强度较棒', '密码强度很棒']},a||{});a.indicator=c("#"+this.data("indicator"));return this.keyup(a,g)}})(jQuery);
