  ...
  if($link)
    {
      ...
      if($select)
      {
        ...
        if (isset($pass['v2ray1_uuid'])){
          ...
          $vmess4 = VmessEncode('如果信息有误','sssrrr.info','80','','v2ray1.sssrrr.info','');
          $vmess5 = VmessEncode('请联系QQ: 993169459','sssrrr.info','80','','v2ray1.sssrrr.info','');
          $vmess6 = VmessEncode('造成不便十分抱歉','sssrrr.info','80','','v2ray1.sssrrr.info','');
          $v = array($vmess1,$vmess2,$vmess3,$vmess4,$vmess5,$vmess6);
          $Final_vmess = FinalVmess($v);
          echo $Final_vmess;
        }
      }
